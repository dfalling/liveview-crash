defmodule CrashWeb.Router do
  ...
  import CrashWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {CrashWeb.Layouts, :root}
  ...
  if Application.compile_env(:crash, :dev_routes) do
  ...
  scope "/", CrashWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{CrashWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", CrashWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{CrashWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", CrashWeb do
    ...
    live_session :current_user,
      on_mount: [{CrashWeb.UserAuth, :mount_current_user}] do
